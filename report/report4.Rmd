...
As seen before, in 20th century there is more content on Disney+ and Prime Video, but scores are highly rated.
For recent years Netflix and Hulu tend to have highly rated movies than the other two.
...
To conclude, quality doesn't equal quantity. Particularily, Prime Video, having the highest number of available movies is not the one holding the best rated movies.
...
Also, these platform concerns different type of movies (genre and age categories) which imply that one platform is better if we are more interested in a certain type of movie and another in a different case.
