...
p <- ggplot(Netflix, aes(x = Age, y = value,
  ...
  scale_fill_manual(values = c("#DBA506","#F93208")) + 
  scale_color_manual(values = c("#E50914", "#E50914","#E50914", "#E50914","#E50914")) +
  guides(color = FALSE)
p
...
p <- ggplot(Hulu, aes(x = Age, y = value,
  ...
  scale_fill_manual(values = c("#DBA506","#F93208")) + 
  scale_color_manual(values = c("#1CE783", "#1CE783","#1CE783", "#1CE783","#1CE783")) +
  guides(color = FALSE)
p
...
p <- ggplot(Prime.Video, aes(x = Age, y = value,
  ...
  scale_fill_manual(values = c("#DBA506","#F93208")) + 
  scale_color_manual(values = c("#00A8E1", "#00A8E1","#00A8E1", "#00A8E1","#00A8E1")) +
  guides(color = FALSE)
p
...
p <- ggplot(Disney., aes(x = Age, y = value,
  ...
  scale_fill_manual(values = c("#DBA506","#F93208")) + 
  scale_color_manual(values = c("#006E99", "#006E99","#006E99", "#006E99","#006E99")) +
  guides(color = FALSE)
p
```
